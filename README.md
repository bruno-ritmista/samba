...
This repo contains SW tools related to samba music notes.

|Name| Purpose| Status| Branch|
|-|-|-|-|
|sheets_to_banana| Converts a Google Sheet of samba percussion notes in a custom table-based into a shareable BananaDrum link.| In development|[sheet_to_banana](https://github.com/bruno-ritmista/samba/tree/sheets_to_banana)|
